...
# DEPRECATION WARNING
This module is now deprecated and has been superseded by the following modules:
...
The form,base and start controllers have been removed and functionality has been moved back into [hof-form-wizard](https://github.com/UKHomeOfficeForms/hof-form-wizard) please see [the hof guide](https://ukhomeofficeforms.github.io/hof-guide/documentation/#completion-behaviour) for more information.
