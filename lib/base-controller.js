...
const Sessions = require('./behaviours/sessions');
const Hooks = require('./behaviours/hooks');

module.exports = class Controller extends mix(BaseController).with(Sessions, Hooks) {
  constructor(options) {
    super(options);
