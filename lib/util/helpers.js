...
module.exports = class Helpers {
   ...
   * @param {Array} stepsJourney - array of steps in journey
   * @returns {String} - the key of the step where field is found
   */
  static getStepFromFieldName(field, stepsConfig, stepsJourney) {
    return _.findKey(_.pick(stepsConfig, stepsJourney), step => step.fields && step.fields.indexOf(field) > -1);
  }
